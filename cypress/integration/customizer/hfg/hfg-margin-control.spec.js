...
function setupCustomizer() {
    ...
    cy.get( '#customize-control-primary-menu_component_margin  .neve-responsive-sizing > .nv-sizing-item  > .top-input' ).click().
        type('{uparrow}{uparrow}').
        trigger('change');

    // Check if linked values
    cy.get( '#customize-control-primary-menu_component_margin  .neve-responsive-sizing > .nv-sizing-item > .top-input' ).
        should( 'have.value', '2' );
    cy.get( '#customize-control-primary-menu_component_margin  .neve-responsive-sizing > .nv-sizing-item > .bottom-input' ).
        should( 'have.value', '2' );
    cy.get( '#customize-control-primary-menu_component_margin  .neve-responsive-sizing > .nv-sizing-item  > .left-input' ).
        should( 'have.value', '2' );
    cy.get( '#customize-control-primary-menu_component_margin  .neve-responsive-sizing > .nv-sizing-item > .right-input' ).
        should( 'have.value', '2' );
    ...
    cy.get( '#customize-control-primary-menu_component_margin  .neve-responsive-sizing > .nv-sizing-item  > .bottom-input' ).click().
        type('{downarrow}').
        trigger('change');
