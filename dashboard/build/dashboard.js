(window["webpackJsonp_neve"] = window["webpackJsonp_neve"] || []).push([["style-dashboard"],{
...
/* harmony import */ var _utils_rest__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/rest */ "./dashboard/src/utils/rest.js");
...
var App = function App(_ref) {
  ...
  Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["useEffect"])(function () {
    Object(_utils_rest__WEBPACK_IMPORTED_MODULE_8__["fetchOptions"])().then(function (r) {
      setSettings(r);
      setLoading(false);
    });
  }, []);
...
/* harmony default export */ __webpack_exports__["default"] = (Object(_wordpress_compose__WEBPACK_IMPORTED_MODULE_10__["compose"])(Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_9__["withDispatch"])(function (dispatch) {
...
var Changelog = function Changelog() {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_Accordion__WEBPACK_IMPORTED_MODULE_2__["default"], {
      ...
      className: "entries"
    }, features.map(function (feature, indexFeature) {
      ...
      className: "entries"
    }, fixes.map(function (fix, indexFixes) {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("li", {
        key: indexFixes,
        dangerouslySetInnerHTML: {
          __html: fix
      ...
      className: "entries"
    }, tweaks.map(function (tweak, indexTweak) {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("li", {
        key: indexTweak,
        dangerouslySetInnerHTML: {
          __html: tweak
  ...
  var renderCustomizerLinks = function renderCustomizerLinks() {
    ...
    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
        className: "col",
        key: index
      }, column.map(function (item, indexColumn) {
        return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], {
          ...
          isLink: true,
          href: item.link
        }, item.text), indexColumn !== column.length - 1 && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("hr", null));
      }));
    }));
  };
...
var LicenseCard = function LicenseCard(_ref) {
  ...
  if (!status) {
    if ('valid' === valid) {
      statusLabel = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Deactivate', 'neve');
    } else {
      statusLabel = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Activate', 'neve');
    }
  }

  if ('activating' === status) {
    statusLabel = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Activating', 'neve');
    statusLabel = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_5__["__"])('Deactivating', 'neve');
  }
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("aside", {
    ...
    onChange: function onChange(e) {
      var keyToSet = e.target.value.replace(/\s+/g, '');
      setKey(keyToSet);
    },
    ...
    disabled: status || !key,
    type: "submit"
  }, statusLabel)), toast && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_Toast__WEBPACK_IMPORTED_MODULE_3__["default"], {
    type: toastType,
    dismiss: setToast,
    message: toast
  ...
  var renderOptionsAccordions = function renderOptionsAccordions() {
    return options.map(function (group, index) {
      var label = group.label,
          optionGroup = group.options;
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_Accordion__WEBPACK_IMPORTED_MODULE_2__["default"], {
        key: index,
        title: label
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", null, Object.keys(optionGroup).map(function (optionSlug, indexGroup) {
        var _optionGroup$optionSl = optionGroup[optionSlug],
            labelGroup = _optionGroup$optionSl.label,
            type = _optionGroup$optionSl.type,
            placeholder = _optionGroup$optionSl.placeholder,
            choices = _optionGroup$optionSl.choices;
...
var Select = function Select(_ref) {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("div", {
    ...
    options: Object.keys(choices).map(function (optionSlug) {
      return {
...
var GlobalSnackbar = function GlobalSnackbar(_ref) {
  ...
  var renderToast = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Option Updated', 'neve');

  if (message === false) {
    renderToast = Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Could not Update Option. Please try again.', 'neve');
  }
