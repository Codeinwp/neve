...
$button_style     = $submenu_style === 'dropdown' ? 'display:none' : '';
$focus_class      = $submenu_style === 'dropdown' ? '' : 'ffocus';
...
<div
	...
	<div id="header-menu-sidebar-bg" class="header-menu-sidebar-bg">
		<div style="<?php echo esc_attr( $button_style ); ?>" class="<?php echo esc_attr( $close_classes ); ?>">
			<button type="button" class="<?php echo esc_attr( $menu_icon_class ); ?> navbar-toggle active <?php echo esc_attr( $focus_class ); ?>" <?php echo ( $item_attributes );// phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
