...
class Logo extends Abstract_Component {
	...
	public function customize_register( WP_Customize_Manager $wp_customize ) {
		...
		$wp_customize->add_setting( $this->id . '_max_width',
			array(
				'default' => 120,
		...
		$wp_customize->add_setting( $this->id . '_show_title',
			array(
				'default' => 1,
				'theme_supports'  => 'hfg_support',
				'transport' => 'postMessage',
		...
		$wp_customize->add_control( new Toggle_Control(
			$wp_customize,
			$this->id . '_show_title',
			[
		...
		$wp_customize->add_setting( $this->id . '_show_tagline',
			array(
				'default' => 0,
				'theme_supports'  => 'hfg_support',
				'transport' => 'postMessage',
		...
		$wp_customize->add_setting( $this->id . '_logo_pos',
			array(
				'default' => 'top',
				'theme_supports'  => 'hfg_support',
				'transport' => 'postMessage',
		...
		$wp_customize->add_control( new Text_Radio_Control(
			$wp_customize,
			$this->id . '_logo_pos',
			[
