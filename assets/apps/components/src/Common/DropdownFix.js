 ...
 *
 * @param {typeof useRef} ref      - The ref of the popover component.
 * @param {Function}      callback - The callback function to be called when the user clicks outside the popover.
 */
