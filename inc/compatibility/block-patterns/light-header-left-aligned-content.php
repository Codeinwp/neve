...
return array(
	...
	'content'    => '<!-- wp:cover {"url":"' . trailingslashit( get_template_directory_uri() ) . 'assets/img/patterns/neve-patterns-18.jpg","id":417,"dimRatio":80,"overlayColor":"nv-light-bg","focalPoint":{"x":"0.16","y":"0.91"},"minHeight":500,"align":"full"} -->
<div class="wp-block-cover alignfull has-background-dim-80 has-nv-light-bg-background-color has-background-dim" style="min-height:500px"><img class="wp-block-cover__image-background wp-image-417" alt="" src="' . trailingslashit( get_template_directory_uri() ) . 'assets/img/patterns/neve-patterns-18.jpg" style="object-position:16% 91%" data-object-fit="cover" data-object-position="16% 91%"/><div class="wp-block-cover__inner-container"><!-- wp:columns {"align":"wide"} -->
