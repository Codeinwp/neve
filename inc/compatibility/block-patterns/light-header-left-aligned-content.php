...
<div class="wp-block-cover alignfull has-background-dim-80 has-nv-light-bg-background-color has-background-dim" style="min-height:500px"><img class="wp-block-cover__image-background" alt="Curved white modern building facade" src="' . trailingslashit( get_template_directory_uri() ) . 'assets/img/patterns/neve-patterns-18.jpg" style="object-position:16% 91%" data-object-fit="cover" data-object-position="16% 91%"/><div class="wp-block-cover__inner-container"><!-- wp:columns {"align":"wide"} -->
<div class="wp-block-columns alignwide"><!-- wp:column {"verticalAlignment":"center","width":"66.66%"} -->
<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:66.66%"><!-- wp:heading {"textAlign":"left","textColor":"neve-text-color"} -->
<h2 class="has-text-align-left has-neve-text-color-color has-text-color">A Hero section over a light background</h2>
<!-- /wp:heading -->
