			...
			<Fragment>
				...
				<div className="neve-typeface-control neve-white-background-control">
					<FontFamilySelector
						...
						maybeGetTypekit={ this.maybeGetTypekitFont }
					/>
				</div>
			</Fragment>
		);
	...
	updateControl() {
		setTimeout( () => {
			this.props.control.setting.set(
				this.maybeGetTypekitFont( this.state.fontFamily )
			);
			wp.customize.previewer.send( 'font-selection', {
				value: this.maybeGetTypekitFont( this.state.fontFamily ),
