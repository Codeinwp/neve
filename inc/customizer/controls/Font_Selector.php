		...
		<div class="hestia-ss-wrap">
			...
			<div class="hestia-fs-dropdown">
				...
				<div class="hestia-fs-options-wrapper">
					...
					<?php
					$this->render_dropdown_options_group( $std_fonts, esc_html__( 'Standard Fonts', 'neve' ) );
					$this->render_dropdown_options_group( $google_fonts, esc_html__( 'Google Fonts', 'neve' ) );
					?>
				</div>
			</div>
