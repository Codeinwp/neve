...
class Upsells extends Base_Customizer {
				...
				[
					...
					'choices'  => [
						...
						'list' => [
							...
							'upsellUrl' => $this->get_upgrade_url( 'woocardlistlayout' ),
						],
					],
				],
				'\Neve\Customizer\Controls\React\Radio_Image'
				...
				[
					...
					'choices'  => [
						...
						'after'    => [
							...
							'upsellUrl' => $this->get_upgrade_url( 'wooaddtocartafter' ),
						],
						'on_image' => [
							...
							'upsellUrl' => $this->get_upgrade_url( 'wooaddtocartonimage' ),
						],
					],
				],
				'\Neve\Customizer\Controls\React\Radio_Image'
				...
				[
					...
					'choices'  => [
						...
						'style-3' => [
							...
							'upsellUrl' => $this->get_upgrade_url( 'woocategorycardboxed' ),
						],
						'style-2' => [
							'name'      => 'Hover',
							...
							'upsellUrl' => $this->get_upgrade_url( 'woocategorycardhover' ),
						],
					],
				],
				'\Neve\Customizer\Controls\React\Radio_Image'
				...
				[
					...
					'choices'       => [
						...
						'outside' => [
							...
							'upsellUrl' => $this->get_upgrade_url( 'woosaletagoutside' ),
						],
					],
				],
				'\Neve\Customizer\Controls\React\Radio_Image'
				...
				[
					...
					'choices'  => [
						...
						'center' => [
							...
							'upsellUrl' => $this->get_upgrade_url( 'wooscardcontentalingcenter' ),
						],
						'right'  => [
							'name'      => __( 'Right', 'neve' ),
							...
							'upsellUrl' => $this->get_upgrade_url( 'wooscardcontentalingright' ),
						],
						'inline' => [
							...
							'upsellUrl' => $this->get_upgrade_url( 'wooscardcontentalinginline' ),
						],
					],
				],
				'\Neve\Customizer\Controls\React\Radio_Image'
		...
		$this->add_control(
			new Control(
				...
				[
					...
					'priority'         => 10000,
					'link'             => $this->get_upgrade_url( 'section-neve_blog_archive_layout' ),
					'features_list'    => array(
						__( 'Image style', 'neve' ),
		...
		$this->add_control(
			new Control(
				...
				[
					...
					'priority'         => 10000,
					'link'             => $this->get_upgrade_url( 'section-neve_single_post_layout' ),
					'features_list'    => array(
				...
				$this->add_control(
					new Control(
						...
						[
							...
							'section'          => $woo_section,
							'priority'         => 10000,
							'link'             => $this->get_upgrade_url( 'section-' . $woo_section ),
							'features_list'    => array(
								__( 'Quick view', 'neve' ),
								__( 'Wishlist', 'neve' ),
		...
		$this->add_section(
			new Section(
				...
				[
					...
					'panel'            => $hfg_header,
					'priority'         => 10000,
					'link'             => $this->get_upgrade_url( 'panel-' . $hfg_header ),
					'features_list'    => array(
	...
	/**
	 * Get the URL for upgrade.
	 * 
	 * @param string      $utm_campaign The campaing slug.
	 * @param string|null $utm_medium The medium slug.
	 * 
	 * @return string - The upgrade URL.
	 */
	private function get_upgrade_url( $utm_campaign, $utm_medium = null ) {
		return tsdk_translate_link( tsdk_utmify( 'https://themeisle.com/themes/neve/upgrade/', $utm_campaign, $utm_medium ) );
	}
}
