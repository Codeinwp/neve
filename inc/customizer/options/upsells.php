...
class Upsells extends Base_Customizer {
				...
				[
					...
					'choices'  => [
						...
						'vertical' => [
							...
							'upsellUrl' => tsdk_translate_link( tsdk_utmify( 'https://themeisle.com/themes/neve/upgrade/', 'woocheckoutvertical' ), 'query' ),
						],
						'stepped'  => [
							...
							'upsellUrl' => tsdk_translate_link( tsdk_utmify( 'https://themeisle.com/themes/neve/upgrade/', 'woocheckoutstepped' ), 'query' ),
						],
					],
				],
				...
				[
					...
					'choices'  => [
						...
						'list' => [
							...
							'upsellUrl' => tsdk_translate_link( tsdk_utmify( 'https://themeisle.com/themes/neve/upgrade/', 'woocardlistlayout' ), 'query' ),
						],
					],
				],
				'\Neve\Customizer\Controls\React\Radio_Image'
				...
				[
					...
					'choices'  => [
						...
						'after'    => [
							...
							'upsellUrl' => tsdk_translate_link( tsdk_utmify( 'https://themeisle.com/themes/neve/upgrade/', 'wooaddtocartafter' ), 'query' ),
						],
						'on_image' => [
							...
							'upsellUrl' => tsdk_translate_link( tsdk_utmify( 'https://themeisle.com/themes/neve/upgrade/', 'wooaddtocartonimage' ), 'query' ),
						],
					],
				],
				'\Neve\Customizer\Controls\React\Radio_Image'
				...
				[
					...
					'choices'  => [
						...
						'style-3' => [
							...
							'upsellUrl' => tsdk_translate_link( tsdk_utmify( 'https://themeisle.com/themes/neve/upgrade/', 'woocategorycardboxed' ), 'query' ),
						],
						'style-2' => [
							'name'      => 'Hover',
							...
							'upsellUrl' => tsdk_translate_link( tsdk_utmify( 'https://themeisle.com/themes/neve/upgrade/', 'woocategorycardhover' ), 'query' ),
						],
					],
				],
				'\Neve\Customizer\Controls\React\Radio_Image'
				...
				[
					...
					'choices'       => [
						...
						'outside' => [
							...
							'upsellUrl' => tsdk_translate_link( tsdk_utmify( 'https://themeisle.com/themes/neve/upgrade/', 'woosaletagoutside' ), 'query' ),
						],
					],
				],
				'\Neve\Customizer\Controls\React\Radio_Image'
				...
				[
					...
					'choices'  => [
						...
						'center' => [
							...
							'upsellUrl' => tsdk_translate_link( tsdk_utmify( 'https://themeisle.com/themes/neve/upgrade/', 'wooscardcontentalingcenter' ), 'query' ),
						],
						'right'  => [
							'name'      => __( 'Right', 'neve' ),
							...
							'upsellUrl' => tsdk_translate_link( tsdk_utmify( 'https://themeisle.com/themes/neve/upgrade/', 'wooscardcontentalingright' ), 'query' ),
						],
						'inline' => [
							...
							'upsellUrl' => tsdk_translate_link( tsdk_utmify( 'https://themeisle.com/themes/neve/upgrade/', 'wooscardcontentalinginline' ), 'query' ),
						],
					],
				],
				'\Neve\Customizer\Controls\React\Radio_Image'
	...
	private function control_upsells() {
		...
		if ( class_exists( 'WooCommerce', false ) ) {
			$woocommerce_sections = array( 'woocommerce_product_catalog', 'woocommerce_checkout', 'neve_single_product_layout' );

			foreach ( $woocommerce_sections as $woo_section ) {
				$this->add_control(
					new Control(
