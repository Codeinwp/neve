...
class Gutenberg extends Generator {
	...
	public function setup_buttons() {
		...
		// Gutenberg
		$this->_subscribers[]  = [
			Dynamic_Selector::KEY_SELECTOR => '.wp-block-button:not(.is-style-secondary) .wp-block-button__link',
			Dynamic_Selector::KEY_RULES    => [
		...
		$this->_subscribers[]  = [
			Dynamic_Selector::KEY_SELECTOR => '.wp-block-button:not(.is-style-secondary) .wp-block-button__link:hover',
			Dynamic_Selector::KEY_RULES    => [
