	...
	public function add_gutenberg_templates( $templates_list ) {
		...
		$templates = array(
			...
			array(
				...
				'type'           => 'block',
				'author'         => $current_theme,
				'keywords'       => array( 'newsletter', 'subscribe' ),
				'categories'     => array( 'content' ),
				'template_url'   => get_template_directory_uri() . '/gutenberg/blocks/newsletter/template.json',
				'screenshot_url' => get_template_directory_uri() . '/gutenberg/blocks/newsletter/screenshot.jpg',
			),
			array(
				'title'          => '',
				'type'           => 'block',
