...
class Config {
	...
	public static $css_selectors_map = [
		...
		self::CSS_SELECTOR_BTN_PRIMARY_PADDING       => '.button.button-primary, .wp-block-button:not(.is-style-secondary) .wp-block-button__link',
		...
		self::CSS_SELECTOR_BTN_PRIMARY_NORMAL        => '.button.button-primary,
				...
				.menu li.button.button-primary > a,  .wp-block-button:not(.is-style-secondary) .wp-block-button__link',
		self::CSS_SELECTOR_BTN_PRIMARY_HOVER         => '.button.button-primary:hover,
				...
				.menu li.button.button-primary > a:hover, .wp-block-button:not(.is-style-secondary) .wp-block-button__link:hover ',
