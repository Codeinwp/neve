...
class Config {
	...
	public static $css_selectors_map = [
		...
		self::CSS_SELECTOR_BTN_PRIMARY_PADDING       => '.button.button-primary, .wp-block-button.is-style-primary .wp-block-button__link,  .wc-block-grid .wp-block-button .wp-block-button__link, .wc-block-featured-category__link .wp-block-button .wp-block-button__link, .wc-block-featured-product__link .wp-block-button .wp-block-button__link',
		...
		self::CSS_SELECTOR_BTN_PRIMARY_NORMAL        => '.button.button-primary,
				...
				.menu li.button.button-primary > a,  .wp-block-button.is-style-primary .wp-block-button__link,  .wc-block-grid .wp-block-button .wp-block-button__link, .wc-block-featured-category__link .wp-block-button .wp-block-button__link, .wc-block-featured-product__link .wp-block-button .wp-block-button__link',
		self::CSS_SELECTOR_BTN_PRIMARY_HOVER         => '.button.button-primary:hover,
				...
				.menu li.button.button-primary > a:hover, .wp-block-button.is-style-primary .wp-block-button__link:hover,  .wc-block-grid .wp-block-button .wp-block-button__link:hover, .wc-block-featured-category__link .wp-block-button .wp-block-button__link:hover, .wc-block-featured-product__link .wp-block-button .wp-block-button__link:hover',
