...
class Main {
	...
	private function get_localization() {
		...
		$data              = [
			...
			'allfeaturesNeveURL'  => esc_url( 'https://themeisle.com/themes/neve/upgrade/?utm_medium=nevedashboard&utm_source=freevspro&utm_campaign=neve&utm_content=seeallfeatures#profeatures' ),
