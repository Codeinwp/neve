...
class Main {
	...
	private function get_localization() {
		...
		$data              = [
			...
			'allfeaturesURL'      => esc_url( 'https://themeisle.com/themes/neve/upgrade/?utm_medium=aboutneve&utm_source=freevspro&utm_campaign=neve&utm_content=seeallfeatures#profeatures' ),
