	...
	private function get_localization() {
		...
		$data              = [
			...
			'strings'                 => [
				...
				'starterSitesCardUpsellMessage' => esc_html__( 'Purchase the Business plan or higher to get instant access to all Premium Starter Sites — including Expert Sites — and much more.', 'neve' ),
				/* translators: %s - Theme name */
