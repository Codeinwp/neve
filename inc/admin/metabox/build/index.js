...
/* harmony import */ var _radio_button_RadioImage__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./radio-button/RadioImage */ "./src/components/radio-button/RadioImage.js");
...
var MetaFieldsManager = function MetaFieldsManager(props) {
  console.log(props);
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["PanelBody"], {
    ...
    icon: "admin-post",
    intialOpen: true
  }, metaSidebar.controls.map(function (metaControl, index) {
    console.log(metaControl);

    if (metaControl.type === 'radio') {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_radio_button_RadioImage__WEBPACK_IMPORTED_MODULE_2__["RadioImage"], {
        key: index,
        id: metaControl.id,
        data: metaControl.settings
      });
...
/***/ "./src/components/radio-button/RadioImage.js":
/*!***************************************************!*\
  !*** ./src/components/radio-button/RadioImage.js ***!
  \***************************************************/
...
var RadioImage = function RadioImage(props) {
...
RadioImage = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_2__["withSelect"])(function (select, props) {
  return {
    metaValue: select('core/editor').getEditedPostAttribute('meta')[props.id]
  };
})(RadioImage);
RadioImage = Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_2__["withDispatch"])(function (dispatch, props) {
  return {
