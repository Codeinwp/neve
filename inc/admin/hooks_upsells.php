	...
	public function render_hook_placeholder() {
		...
		foreach ( $hooks as $hooks_in_category ) {
			foreach ( $hooks_in_category as $hook_value ) {
				...
				add_action(
					$hook_value,
					function () use ( $hook_label, $upsell_label ) {
